  ...
  return (
    <main>
      ...
      <section className="w-full py-14 mt-40  bg-primary-100  ">
        <div className="grid grid-cols-3 w-full max-w-6xl m-auto justify-around items-center">
          <Animation delay="0.2s">
            <div
              className={`flex flex-col relative gap-2 text-white justify-center items-center `}
            >
              <span
