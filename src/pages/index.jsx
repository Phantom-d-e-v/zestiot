...
export default function Home() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      if (element5) {
        const elementTop = element5.getBoundingClientRect().top;
        const windowHeight = window.innerHeight;
        if (elementTop < windowHeight * 0.75) {
          setIsVisible5(true);
        }
      }
      const element6 = elementRef6.current;
      if (element6) {
        const elementTop = element6.getBoundingClientRect().top;
        const windowHeight = window.innerHeight;
        if (elementTop < windowHeight * 0.75) {
          setIsVisible6(true);
        }
      }
      const element7 = elementRef7.current;
      if (element7) {
        const elementTop = element7.getBoundingClientRect().top;
        const windowHeight = window.innerHeight;
        if (elementTop < windowHeight * 0.75) {
          setIsVisible7(true);
        }
      }
      const element8 = elementRef8.current;
      if (element8) {
        const elementTop = element8.getBoundingClientRect().top;
        const windowHeight = window.innerHeight;
        if (elementTop < windowHeight * 0.75) {
          setIsVisible8(true);
        }
      }
      const element9 = elementRef9.current;
      if (element9) {
        const elementTop = element9.getBoundingClientRect().top;
        const windowHeight = window.innerHeight;
        if (elementTop < windowHeight * 0.75) {
          setIsVisible9(true);
        }
  ...
  return (
    <main>
      ...
      <div
        ref={elementRef3}
        className={`fade-in ${isVisible3 ? "active" : ""}`}
      >
      ...
      <div
        ref={elementRef4}
        className={`fade-in ${isVisible4 ? "active" : ""}`}
      >
      ...
      <div
        ref={elementRef5}
        className={`fade-in ${isVisible5 ? "active" : ""}`}
      >
      ...
      <div
        ref={elementRef6}
        className={`fade-in ${isVisible6 ? "active" : ""}`}
      >
        <section>
      ...
      <div
        ref={elementRef7}
        className={`fade-in ${isVisible7 ? "active" : ""}`}
      >
        <section className=" mt-40 mb-40">
          <div className=" px-3 max-w-7xl m-auto">
            ...
            <p className=" text-center w-full lg:text-4xl md:text-3xl text-2xl mt-10 mb-28 ">
              ...
              customers who have experienced the trans formative power of our
              IoT solutions ﬁrsthand. Take a look at our{" "}
              <span className=" text-primary-100">case studies</span> to read
              about some of our success stories and see how our IoT solutions
              have made a real impact for our customers.
            </p>
          </div>
        </section>
      </div>
      <div
        ref={elementRef8}
        className={`fade-in ${isVisible8 ? "active" : ""}`}
      >
        <section>
          {/* eslint-disable-next-line @next/next/no-img-element */}
      ...
      <div
        ref={elementRef9}
        className={`fade-in ${isVisible9 ? "active" : ""}`}
      >
